...
function picture(id) {
    ...
    if(id = 453){
    	...
    	var contentHtml = "";
    	contentHtml += '<li style="display:block;"><img style="height:200px;width:300px;position:absolute;left:50%;top:50%;margin-left:-150px;margin-top:-100px;" src="http://192.168.1.201:8081/upload/1505817979604.JPG"/></li>';
...
function videoPlayClick() {
    ...
    //调用视频接口
    $("#myVideo").attr("src", "http://192.168.1.201:8081/upload/car.mp4");//更新url
